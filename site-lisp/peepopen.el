...
(defun peepopen-bind-aquamacs-keys ()
  ...
  (define-key osx-key-mode-map (kbd "A-f") 'peepopen-goto-file-gui)
  (define-key *textmate-mode-map* (kbd "A-f") 'peepopen-goto-file-gui))

(defun peepopen-bind-carbon-keys ()
  (define-key *textmate-mode-map* [(meta f)] 'peepopen-goto-file-gui))

(defun peepopen-bind-ns-keys ()
  (define-key *textmate-mode-map* [(super f)] 'peepopen-goto-file-gui))
